...
describe('game controller',()=>{
	...
	test('change game status to game-setup',()=>{
		expect(phaseControl(initialState,gameSetup())).toEqual(Object.assign({},initialState,{gameControl:{view:'game-setup'}}))
	})
	...
	test('start game with initial setup',()=>{
		...
		expect(phaseControl(initialState,gameStart(gameLength,players))).toEqual(Object.assign({},initialState,{gameControl:{view:'game-start',gameLength:gameLength,players:players}}))
	})

	test('change game status to game-end',()=>{
		expect(phaseControl(initialState,gameEnd())).toEqual(Object.assign({},initialState,{gameControl:{view:'game-end'}}))
	})
